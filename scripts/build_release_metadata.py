...
LAYERS = [
    ...
    },
    {
        ...
        'path': 'data/subtel_segments/subtel_access_segmented_2015_2025.csv',
        'source_family': 'SUBTEL access/use survey SAV files',
    ...
    },
    {
        ...
        'path': 'data/ookla/territorial/chile_2026q1_commune_summary.csv',
        'source_family': 'Ookla Open Data',
        'reference_period': '2026Q1',
...
def main() -> None:
    ...
    # Do not hash transient caches if ever present.
    paths = {p for p in paths if '__pycache__' not in p.parts and '.git' not in p.parts}
