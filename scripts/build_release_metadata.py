...
LAYERS = [
    ...
    layer(
        'subtel_sector_2026q2', 'data/subtel_sector_2026/sector_snapshot_2026q2.csv',
        'SUBTEL sector statistics', '2026Q2', 'national', 'connection / sector estimate',
        'current sector context and technology mix',
    ),
    layer(
        'subtel_portability_2026q2',
        'data/subtel_portability_2026/portability_summary_q2_2026.csv',
        'SUBTEL portability statistics', '2026Q2', 'national', 'portability event aggregate',
        'quarterly and cumulative portability context; not access or coverage',
        license_note='Public official publication; retain source attribution and interpretation limits',
    ),
    layer(
        'subtel_sector_longitudinal_2026m06', 'data/subtel_sector_series/sector_core_monthly_long.csv',
        'SUBTEL administrative Internet series', 'effective workbook ranges through 2026-06',
    ...
    layer(
        ...
        'SUBTEL administrative fixed Internet workbook', '2026-06', 'commune',
        'administrative fixed connection',
        'current reconciled communal total and residential fixed Internet connections',
